...
const ReactBoilerplate = {
     ...
     * dependencies. We enable it by default in development.
     *
    ...
    dllPlugin: {
        defaults: {
            /**
             * we need to exclude dependencies which are not intended for the
             * browser by listing them here.
             */
            exclude: [
                "chalk",
                "compression",
            ...
            /**
             * Specify any additional dependencies here. We include core-js and
             * lodash since a lot of our dependencies depend on them and they
             * get picked up by webpack.
             */
            include: [
                "core-js",
